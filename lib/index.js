...
internals.sign = (payload, options, secretOrPrivateKey) => {
  let settings = {};
  ...
  const key = secretOrPrivateKey || internals.key;

  return jwt.sign(payload, key, settings);
};
